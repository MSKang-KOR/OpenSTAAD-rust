...
impl<'a> Group<'a> {
    ...
    pub fn create_group_ex(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "CreateGroupEx", &mut params);
    ...
    pub fn delete_group(&self, group_name: &str) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "DeleteGroup", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result_code)
    ...
    pub fn get_group_count(&self, group_type: i32) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "GetGroupCount", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn get_group_count_all(&self) -> Result<i32, anyErr> {
        let result_variant = unsafe {
            invoke_method_with_result(&self.geometry.dispatch, "GetGroupCountAll", &mut [])
        };
        match result_variant {
            Ok(var) => {
    ...
    pub fn get_group_entities(&self, group_name: &str) -> Result<(i32, Vec<i32>), anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "GetGroupEntities", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn get_group_names(&self, group_type: i32) -> Result<(i32, Vec<String>), anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "GetGroupNames", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
    ...
    pub fn update_group(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "UpdateGroup", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result_code)
