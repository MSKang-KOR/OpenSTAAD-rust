...
impl<'a> Beam<'a> {
    ...
    pub fn add_beam(&self, node_a: i32, node_b: i32) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "AddBeam", &mut params);
    ...
    pub fn add_multiple_beams(&self, incidences: Vec<Vec<i32>>) -> Result<(), anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "AddMultipleBeams", &mut params);
            match result_variant {
                Ok(_) => anyOk(()),
    ...
    pub fn create_beam(&self, beam_no: i32, node_a: i32, node_b: i32) -> Result<(), anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "CreateBeam", &mut params);
            match result_variant {
                Ok(_) => anyOk(()),
    ...
    pub fn delete_beam(&self, beam_no: i32) -> Result<(), anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "DeleteBeam", &mut params);
            match result_variant {
                Ok(_) => anyOk(()),
    ...
    pub fn get_beam_length(&self, beam_no: i32, base_unit: i32) -> Result<f64, anyErr> {
        unsafe {
            ...
            let mut params = [VARIANT::from(beam_no)];
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "GetBeamLength", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn get_beam_list(&self) -> Result<Vec<i32>, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "GetBeamList", &mut params);
            match result_variant {
                Ok(_) => {
    ...
    pub fn get_last_beam_no(&self) -> Result<i32, anyErr> {
        let result_variant =
            unsafe { invoke_method_with_result(&self.geometry.dispatch, "GetLastBeamNo", &mut []) };
        match result_variant {
            Ok(var) => {
    ...
    pub fn get_member_count(&self) -> Result<i32, anyErr> {
        let result_variant = unsafe {
            invoke_method_with_result(&self.geometry.dispatch, "GetMemberCount", &mut [])
        };
        match result_variant {
            Ok(var) => {
    ...
    pub fn intersect_beams(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "IntersectBeams", &mut params);
    ...
    pub fn is_beam(&self, member_no: i32, tolerance_angle: f64) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "IsBeam", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn is_column(&self, member_no: i32, tolerance_angle: f64) -> Result<i32, anyErr> {
        unsafe {
            let mut params = [VARIANT::from(tolerance_angle), VARIANT::from(member_no)];
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "IsColumn", &mut params);
            match result_variant {
                Ok(var) => {
                    let result = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result)
    ...
    pub fn is_z_up(&self) -> Result<bool, anyErr> {
        let result_variant =
            unsafe { invoke_method_with_result(&self.geometry.dispatch, "IsZUp", &mut []) };
        match result_variant {
            Ok(var) => {
    ...
    pub fn merge_beams(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "MergeBeams", &mut params);
            match result_variant {
                Ok(var) => {
                    let success = VariantToInt32(&var as *const VARIANT).unwrap() > 0;
                    anyOk(success)
    ...
    pub fn renumber_beam(&self, old_beam_no: i32, new_beam_no: i32) -> Result<bool, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "RenumberBeam", &mut params);
            match result_variant {
                Ok(var) => {
                    let success = VariantToInt32(&var as *const VARIANT).unwrap() > 0;
                    anyOk(success)
    ...
    pub fn split_beam(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.geometry.dispatch, "SplitBeam", &mut params);
            match result_variant {
                Ok(_) => anyOk(()),
