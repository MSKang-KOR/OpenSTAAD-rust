...
impl<'a> Specification<'a> {
    ...
    pub fn create_member_inactive_spec(&self) -> Result<i32, anyErr> {
        let result_variant = unsafe {
            invoke_method_with_result(&self.property.dispatch, "CreateMemberInactiveSpec", &mut [])
        };
        match result_variant {
            Ok(var) => {
                let result_code = unsafe { VariantToInt32(&var as *const VARIANT).unwrap() };
    ...
    pub fn create_member_tension_spec(&self) -> Result<i32, anyErr> {
        let result_variant = unsafe {
            invoke_method_with_result(&self.property.dispatch, "CreateMemberTensionSpec", &mut [])
        };
        match result_variant {
            Ok(var) => {
                let result_code = unsafe { VariantToInt32(&var as *const VARIANT).unwrap() };
    ...
    pub fn create_member_truss_spec(&self) -> Result<i32, anyErr> {
        let result_variant = unsafe {
            invoke_method_with_result(&self.property.dispatch, "CreateMemberTrussSpec", &mut [])
        };
        match result_variant {
            Ok(var) => {
                let result_code = unsafe { VariantToInt32(&var as *const VARIANT).unwrap() };
    ...
    pub fn delete_member_spec(&self, spec_no: i32) -> Result<bool, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.property.dispatch, "DeleteMemberSpec", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result_code == 1)
    ...
    pub fn delete_property(&self, property_id: i32) -> Result<bool, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.property.dispatch, "DeleteProperty", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result_code == 1)
    ...
    pub fn get_inactive_member_count(&self) -> Result<i32, anyErr> {
        let result_variant = unsafe {
            invoke_method_with_result(&self.property.dispatch, "GetInactiveMemberCount", &mut [])
        };
        match result_variant {
            Ok(var) => {
