...
impl<'a> Support<'a> {
    pub fn new(root: &'a Root) -> Self {
        let dispatch =
            unsafe { get_dispatch(root.dispatch.as_ref().unwrap(), "Support", &mut []).unwrap() };
        Self { root, dispatch }
    }
    ...
    pub fn assign_support_to_node(&self, node_no: i32, support_no: i32) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.dispatch, "AssignSupportToNode", &mut params);
    ...
    pub fn create_inclined_support(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.dispatch, "CreateInclinedSupport", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn create_support_fixed(&self) -> Result<i32, anyErr> {
        let result_variant =
            unsafe { invoke_method_with_result(&self.dispatch, "CreateSupportFixed", &mut []) };
        match result_variant {
            Ok(var) => {
    ...
    pub fn create_support_fixed_but(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.dispatch, "CreateSupportFixedBut", &mut params);
            match result_variant {
                Ok(var) => {
                    let support_id = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(support_id)
    ...
    pub fn create_support_pinned(&self) -> Result<i32, anyErr> {
        let result_variant =
            unsafe { invoke_method_with_result(&self.dispatch, "CreateSupportPinned", &mut []) };
        match result_variant {
            Ok(var) => {
                let support_id = unsafe { VariantToInt32(&var as *const VARIANT).unwrap() };
                anyOk(support_id)
    ...
    pub fn delete_support(&self, support_no: i32) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.dispatch, "DeleteSupport", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result_code)
    ...
    pub fn get_support_name(&self, support_no: i32) -> Result<String, anyErr> {
        unsafe {
            let mut params = [VARIANT::from(support_no)];
            let result_variant =
                invoke_method_with_result(&self.dispatch, "GetSupportName", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn get_support_unique_id(&self, support_no: i32) -> Result<String, anyErr> {
        unsafe {
            let mut params = [VARIANT::from(support_no)];
            let result_variant =
                invoke_method_with_result(&self.dispatch, "GetSupportUniqueID", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn remove_support_from_node(&self, node_no: i32) -> Result<bool, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.dispatch, "RemoveSupportFromNode", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn set_support_unique_id(&self, support_no: i32, unique_id: &str) -> Result<(), anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.dispatch, "SetSupportUniqueID", &mut params);
            match result_variant {
                Ok(_) => anyOk(()),
    ...
    pub fn get_support_count(&self) -> Result<i32, anyErr> {
        let result_variant =
            unsafe { invoke_method_with_result(&self.dispatch, "GetSupportCount", &mut []) };
        match result_variant {
            Ok(var) => {
    ...
    pub fn get_support_information(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.dispatch, "GetSupportInformation", &mut params);
    ...
    pub fn get_support_information_ex(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.dispatch, "GetSupportInformationEx", &mut params);
    ...
    pub fn get_support_nodes(&self) -> Result<(i32, Vec<i32>), anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.dispatch, "GetSupportNodes", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn get_support_type(&self, support_node: i32) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method_with_result(&self.dispatch, "GetSupportType", &mut params);
            match result_variant {
                Ok(var) => {
                    let support_type = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(support_type)
