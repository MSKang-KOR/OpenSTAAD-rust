use crate::openstaad::{
    ...
    tools::invoke::{get_dispatch, invoke_method},
...
impl<'a> Support<'a> {
    ...
    pub fn assign_support_to_node(&self, node_no: i32, support_no: i32) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method(&self.dispatch, "AssignSupportToNode", &mut params);
    ...
    pub fn delete_support(&self, support_no: i32) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method(&self.dispatch, "DeleteSupport", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result_code)
    ...
    pub fn get_support_name(&self, support_no: i32) -> Result<String, anyErr> {
        unsafe {
            let mut params = [VARIANT::from(support_no)];
            let result_variant =
                invoke_method(&self.dispatch, "GetSupportName", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn get_support_unique_id(&self, support_no: i32) -> Result<String, anyErr> {
        unsafe {
            let mut params = [VARIANT::from(support_no)];
            let result_variant =
                invoke_method(&self.dispatch, "GetSupportUniqueID", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn set_support_unique_id(&self, support_no: i32, unique_id: &str) -> Result<(), anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method(&self.dispatch, "SetSupportUniqueID", &mut params);
            match result_variant {
                Ok(_) => anyOk(()),
    ...
    pub fn get_support_count(&self) -> Result<i32, anyErr> {
        let result_variant =
            unsafe { invoke_method(&self.dispatch, "GetSupportCount", &mut []) };
        match result_variant {
            Ok(var) => {
    ...
    pub fn get_support_nodes(&self) -> Result<(i32, Vec<i32>), anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method(&self.dispatch, "GetSupportNodes", &mut params);
            match result_variant {
                Ok(var) => {
    ...
    pub fn get_support_type(&self, support_node: i32) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method(&self.dispatch, "GetSupportType", &mut params);
            match result_variant {
                Ok(var) => {
                    let support_type = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(support_type)
