...
impl<'a> Definition<'a> {
    ...
    pub fn add_wind_definition(&self, type_no: i32, type_name: &str) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method(&self.load.dispatch, "AddWindDefinition", &mut params);
    ...
    pub fn add_wind_exposure(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method(&self.load.dispatch, "AddWindExposure", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result_code)
    ...
    pub fn add_wind_intensity(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method(&self.load.dispatch, "AddWindIntensity", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result_code)
    ...
    pub fn delete_wind_definition(&self, type_no: i32) -> Result<i32, anyErr> {
        unsafe {
            ...
            let result_variant =
                invoke_method(&self.load.dispatch, "DeleteWindDefinition", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result_code)
    ...
    pub fn add_seismic_definition(
        ...
        unsafe {
            ...
            let result_variant =
                invoke_method(&self.load.dispatch, "AddSeismicDefinition", &mut params);
            match result_variant {
                Ok(var) => {
                    let result_code = VariantToInt32(&var as *const VARIANT).unwrap();
                    anyOk(result_code == 1)
