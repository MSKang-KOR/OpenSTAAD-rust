...
use crate::staad::notify::watch_file_background;
    ...
    match process.start().await {
        ...
        _ => {
            ...
            if let Some(root) = process.root.as_ref() {
                ...
                // if let Some(geometry) = process.geometry.as_ref() {
                ...
                //     let get_node_incidence_cis2_result =
                //         node.get_node_incidence_cis2(1789, base_unit);
                ...
                //         node.get_node_number(10578.4, 115.5, -9478.459444444, base_unit);
